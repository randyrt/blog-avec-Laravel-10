...
<body class="pt-10 pb-16 antialiased bg-white md:pb-32">
    {{-- Conteneur global --}}
        ...
        <header class="flex items-center justify-between space-x-5 text-slate-900">
            ...
            <nav x-data="{ open: false }" x-cloak class="relative">
                <button
                    ...
                    class="flex w-8 h-8 text-sm bg-white rounded-full md:hidden focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
                ...
                <ul
                    ...
                    class="absolute right-0 z-10 w-48 py-1 mt-2 origin-top-right bg-white rounded-md shadow-lg md:hidden ring-1 ring-black ring-opacity-5 focus:outline-none"
                    tabindex="-1"
                >
                    <li><a href="{{ route('register') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Connexion</a></li>
                    <li>
